            ...
            <section className="pt-10 md:pt-20">
                <div className="container mx-auto px-4">
                    <div className="grid md:grid-cols-2 gap-10 lg:gap-20">
                        <div className="relative w-full h-0 pb-[100%] rounded-[20px] border-2 border-primary">
                            <div>
                                <Image
                                    src={
                        ...
                        <div>
                            {strain?.isAvailable ? (
                                <div className="flex gap-2 items-start mb-16">
                                    <span className="block w-3.5 h-3.5 bg-primary rounded-full mt-1" />
                            ...
                            <h1 className="h2 mb-1 text-primary">{strain.name}</h1>
                        ...
                        session?.user?.dappUser?.isKYCVerified ? (
                            ...
                            <div className="grid gap-4">
                                <p className="capitalize">
                                    <strong className="text-primary">FEELINGS: </strong>
                                    {strain.feelings}
                                </p>
                                <p className="capitalize">
                                    <strong className="text-primary">HELPS WITH: </strong>
                                    {strain.helpsWith}
                                </p>
                                <p className="capitalize">
                                    <strong className="text-primary">FLAVOURS: </strong>
                                    {strain.flavour}
                                </p>
                                <p className="capitalize">
                                    <strong className="text-primary">POPULARITY: </strong>
                                    {strain.popularity}
                                </p>
                            </div>
                        </div>
