...
export default function DeleteAccountButton(props) {
    ...
    return (
        <div className="relative">
            <div
                className={`absolute  border-primary border-2 bottom-full right-1/2 translate-x-1/2 bg-black p-6 rounded-[20px] w-[300px] mb-6 duration-500 ease-in-out ${popup ? "opacity-full" : "opacity-0"
                    }`}
            >
                {deleteRequest ? (
                    <div>
