    ...
    return (
        <div className="grid xl:grid-cols-3 gap-8">
            <div className="xl:col-span-2">
                ...
                {cart?.cartItems && (
                    <button
                        className="float-right mt-4 py-4 px-6 rounded-full bg-transparent  border-primary border-2 text-[15px] shadow hover:shadow-[0_0_15px_0px_#D05D1A] duration-200 ease-in-out"
            ...
            <div className=" rounded-[20px] border-2 border-white p-4 sm:p-8 flex flex-col justify-between items-start gap-16">
                <div>
                ...
                <div className="relative w-full">
                    {cart?.cartItems && (
                        <div>
                            ...
                            <button
                                className="mb-4 w-full py-4 px-6 rounded-full bg-[#D05D1A] text-[15px] shadow hover:shadow-[0_0_15px_0px_#D05D1A] duration-200 ease-in-out"
                                title="CHECKOUT"
                    ...
                    {checkoutSuccess && (
                        <p className="text-[#D05D1A]">{checkoutSuccess}</p>
                    )}
                </div>
            </div>
        </div>
