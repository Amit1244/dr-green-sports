    ...
    return (
        <>
            <div className="sm:col-span-2 grid sm:flex gap-2 sm:gap-4 items-center">
                <div className="h-[75px] sm:h-[100px] lg:h-[150px] min-w-[75px] sm:min-w-[100px] lg:min-w-[150px] w-fit relative rounded-[10px] sm:rounded-[20px] border-2 border-primary p-2 sm:p-4">
                ...
                <div>
                    <p className="text-sm sm:text-lg lg:text-2xl mb-1 text-primary">
            ...
            <div className="text-center flex justify-center">
                <div className="relative">
                    <div className="py-1 sm:py-3 px-1 sm:px-4 rounded-full bg-transparent  border-primary border-2 text-[15px] shadow hover:shadow-[0_0_15px_0px_#ffffff] duration-200 ease-in-out flex items-center">
                        <button
            ...
            <p className="text-sm sm:text-lg lg:text-2xl text-end text-primary">
                ${total.toFixed(2)}
            </p>
        </>
    );
