    ...
    return (
        <div>
            <div className="flex gap-4 items-center mb-8">
                <p className="opacity-50 text-primary">Quantity</p>
            ...
            <div className="relative mb-16 text-center">
                <div className="relative">
                    <button
                        className="w-full py-4 px-6 rounded-full bg-transparent border-primary bg-primary border-2 text-[15px] shadow hover:shadow-[0_0_15px_0px_#D05D1A] duration-200 ease-in-out"
                        title="ADD TO CART"
                        onClick={cartHandler}
                    >
                        ADD TO CART
                ...
                {cartMessage && (
                    <Link href="/cart">
                        <button
                            className="w-full mt-10 uppercase py-4 px-6 rounded-full border-primary border-2 text-[15px] shadow hover:shadow-[0_0_15px_0px_#D05D1A] duration-200 ease-in-out"
                            title="View Cart"
                        >
                            View Cart
                        </button>
