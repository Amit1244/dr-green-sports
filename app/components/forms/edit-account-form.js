        ...
        >
                ...
                <div>
                    ...
                    <div>
                        <input
                            ...
                            className="p-4 rounded-[7px] border-2 border-[#D05D1A] font-normal bg-transparent outline-0 w-full font-medium"
                        />
                    </div>
            ...
            <div>
                ...
                <div>
                    <select
                        ...
                        className="appearance-none p-4 rounded-[7px] border-2 text-black border-[#D05D1A]  bg-transparent outline-0 w-full font-medium"
                        required
                    ...
                    <div>
                        ...
                        <div>
                            <select
                                ...
                                autoComplete="country"
                                className="appearance-none p-4 rounded-[7px] border-2 border-[#D05D1A] font-normal bg-transparent outline-0 w-full font-medium"
                                onChange={(e) =>
            ...
            <div className="flex justify-center">
                <button
                    type="submit"
                    title="UPDATE"
                    className={`py-4 px-6 rounded-full bg-[#D05D1A] shadow border border-[#D05D1A] border-2 hover:shadow-[0_0_15px_0px_#D05D1A] duration-200 ease-in-out cursor-pointer flex gap-2 justify-center items-center ${isPending ? "pointer-events-none" : ""
                        }`}
                >
                    UPDATE
                    <svg
            ...
            <div className="text-center">
                ...
                {state?.success && !isPending && (
                    <p className="text-[#D05D1A] text-center">
                        {state?.message}
                    </p>
                )}
            </div>
