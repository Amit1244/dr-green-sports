...
export default function ReferForm(props) {
    ...
    return (
        ...
        >
                ...
                <div>
                    ...
                    <div>
                        <input
                            ...
                            className="p-4 rounded-[7px] border-2 border-primary bg-transparent outline-0 w-full font-medium opacity-50"
                ...
                <div>
                    ...
                    <div>
                        <input
                            ...
                            className="p-4 rounded-[7px] border-2 border-primary font-normal bg-transparent outline-0 w-full font-medium opacity-50"
                ...
                <div>
                    ...
                    <div>
                        <input
                            ...
                            type="date"
                            autoComplete="bday"
                            className="p-4 rounded-[7px] border-2 border-primary font-normal bg-transparent outline-0 w-full font-medium"
                            value={dob}
            ...
            <div>
                ...
                <div>
                    <input
                        ...
                        className="appearance-none p-4 rounded-[7px] border-2 border-primary font-normal bg-transparent outline-0 w-full font-medium opacity-50"
            ...
            <div
                className="text-sm sm:text-lg p-4 rounded-[7px] border-2 border-primary font-normal bg-transparent outline-0 w-full font-medium max-h-[400px] overflow-y-scroll consent-form"
            ...
            <div className="flex justify-center items-center gap-4 flex-wrap">
                <button
                    type="submit"
                    title="Save"
                    className={`uppercase py-4 px-6 rounded-full border border-primary border-2 bg-primary shadow hover:shadow-[0_0_15px_0px_#0ABA90] duration-200 ease-in-out cursor-pointer flex gap-2 justify-center items-center ${isPending ? "pointer-events-none" : ""
                        }`}
                >
                    Save
                    <svg
            ...
            {state?.success && (
                <p className="text-primary text-center">{state?.message}</p>
            )}
        </form>
    );
}
