        ...
        >
            ...
            <div className="justify-center grid items-center">
                <button
                    ...
                    className={`py-4 px-6 rounded-full bg-[#0ABA90] shadow border border-[#0ABA90] border-2 hover:shadow-[0_0_15px_0px_#0ABA90] duration-200 ease-in-out cursor-pointer flex gap-2 justify-center items-center ${isPending ? "pointer-events-none" : ""
                        }`}
                >
                    CONFIRM PASSWORD
                    <svg
        ...
        >
            ...
            <div className="justify-center grid items-center">
                <button
                    type="submit"
                    title="CONFIRM EMAIL"
                    className="mr-auto py-4 px-6 border-primary border-2 rounded-full bg-primary shadow hover:shadow-[0_0_15px_0px_#0ABA90] duration-200 ease-in-out cursor-pointer flex gap-2 justify-center items-center"
                >
                    CONFIRM EMAIL
                    <svg
                        className={`animate-spin h-4 w-4 text-white ${isPending ? "inline" : "hidden"
